...
# btn1 = HoverButton(window, images=pic_arrow_left, image_alt = pic_f1_f2)
# btn1.place(x=1, y=10, width=58, height=58)
...
btn1 = HoverButton(window, images=pic_arrow_left)
btn1.place(x=4, y=13, width=58, height=58)
btn1.bind( "<Button>", lambda x: sock.send("zu sendende daten hier reinschreiben") )
btn1.configure(background='black')
btn1.configure(border=0)


btn2 = HoverButton(window, images=pic_one)
btn2.place(x=63, y=13, width=58, height=58)
...
btn3 = HoverButton(window, images=pic_two)
btn3.place(x=123, y=13, width=58, height=58)
...
btn4 = HoverButton(window, images=pic_three)
btn4.place(x=183, y=13, width=58, height=58)
...
btn5 = HoverButton(window, images=pic_four)
btn5.place(x=243, y=13, width=58, height=58)
...
btn6 = HoverButton(window, images=pic_five)
btn6.place(x=303, y=13, width=58, height=58)
...
btn7 = HoverButton(window, images=pic_six)
btn7.place(x=363, y=13, width=58, height=58)
...
btn8 = HoverButton(window, images=pic_seven)
btn8.place(x=423, y=13, width=58, height=58)
...
btn9 = HoverButton(window, images=pic_eight)
btn9.place(x=483, y=13, width=58, height=58)
...
def shift_lock(ignoredclick):
    btn_shift_lock.locked = not btn_shift_lock.locked
    sock.send("zu sendende daten hier reinschreiben")
...
btn_shift_right.bind( "<Button>", lambda x: sock.send("zu sendende daten hier reinschreiben") )

...
#         s.put("(75,LOW)")#Links high
#        print("Hat geklappt") 
 
        devices = [evdev.InputDevice(path) for path in evdev.list_devices()]
        for device in devices:
            print(device.path, device.name, device.phys)
        gamepad = evdev.InputDevice('/dev/input/event1')
        return gamepad
...
#                     if(a):
#                         print ("(71,LOW)")
#                         s.put("(71,LOW)") #Links Low
#                         a = False
#                     if(not b):
#                         print ("(72,HIGH)")
#                         s.put("(72,HIGH)") #Rechts high
#                         b = True
#                     sleep(0.1)
#                 else:
...
#                     if(not c):
#                         print ("(73,HIGH)")
#                         s.put("(73,HIGH)") #oben high
#                         c = True
#                     if(d):
#                         print ("(74,LOW)")
#                         s.put("(74,LOW)") #unten low
#                         d = False
#                     sleep(0.1)
#                 elif x.value > 131:
#                     richtung = richtung + "U"
    ...
    for event in gamepad.read_loop(): 
        ...
        if x.type == 3:
            if x.code == 2 or x.code == 0:
                ...
                if x.value >= 126 and x.value <= 130:
                    #print "HORIZONTAL-MITTE"
                    rechts = False
                    links = False
